 ...
 * 
 * LEARNING POINTS:
 * - REST API: Uses HTTP methods (GET, POST, PUT) for operations
 * - JSON: All data is in JSON format (JavaScript Object Notation)
 * - Express.js: Popular Node.js framework for building web servers
 * - CORS: Allows requests from different origins (like our frontend)
 */
 ...
 * GET    /api/routes/123    → Get specific route
 * PUT    /api/routes/123    → Update specific route
 */
 ...
 * 
 * 2. Express.js:
 *    - app.get(), app.post(), app.put() define endpoints
 ...
 * 
 * 4. This Mock Service:
 *    - Simulates a cloud route optimization API
 *    - Stores routes in memory (Map data structure)
 *    - Returns realistic-looking data
 *    - Will be used to test our middleware integration
 */
