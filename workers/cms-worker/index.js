 ...
 * CMS Worker
 * 
 * Processes client management system requests from RabbitMQ
 * and calls the Mock CMS SOAP service.
 * 
 * LEARNING: This worker shows how to consume messages from RabbitMQ
 * and call a SOAP service (which is XML-based).
 */
