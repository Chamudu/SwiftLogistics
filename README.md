...
- [x] **Polish** — Wire all pages to live data
...
Developed collectively by Chamudu, Newandie, Tharusha, Thivinya, and Santhosh as an academic implementation assignment spanning distributed systems, API gateways, and reliable messaging.
